...
var _greeting = require("./src/greeting");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (0, _buttons.stopTime)(button);
    (0, _greeting.setGreeting)(greeting); // greeting for night morning day and evening
    (0, _clock.forClock)(clock); // clockie clock, need to find out how to make it a proper clock not text
    (0, _clock.timeIsRunning)(percent); // future scary reminder of how quickly time passes 
});

},{"./src/greeting":"8W0X1","./src/clock":"fJoIQ","./src/buttons":"lf35D"}],"8W0X1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setGreeting", ()=>setGreeting);
const setGreeting = (element)=>{
    const update = ()=>{
        const html = document.getElementsByTagName("html")[0];
        const nowHours = new Date().getHours();
        if (nowHours >= 0 && nowHours <= 6) {
            element.textContent = "What a great night, isn't it?";
            html.setAttribute("style", "background-image: url(https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2944&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);");
        } else if (nowHours > 6 && nowHours <= 11) {
            element.textContent = "Morning, Veronchik! Still sleepy?";
            html.setAttribute("style", "background-image: url(https://images.unsplash.com/photo-1682687220509-61b8a906ca19?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);");
        } else if (nowHours > 11 && nowHours <= 18) {
            element.textContent = "What a great day to be miserable again!";
            html.setAttribute("style", "background-image: url(https://images.unsplash.com/photo-1621967962337-1125dcaabba0?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);");
        } else {
            element.textContent = "Wow, hyperfocus time!";
            html.setAttribute("style", "background-image: url(https://images.unsplash.com/photo-1612543827278-d19245d6a00d?q=80&w=3028&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);");
        }
    };
    update();
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "forClock", ()=>forClock);
parcelHelpers.export(exports, "timeIsRunning", ()=>timeIsRunning);
var _helpers = require("./util/helpers");
const forClock = (element)=>{
    ...
    const updateClock = ()=>{
        ...
        if (cachedTimeZoneStr === null) cachedTimeZoneStr = (0, _helpers.timeZoneStr)();
...
const timeIsRunning = (percent)=>{
    const update = ()=>{
        ...
        } else percent.textContent = "My extra gigachad algorithm tells me that it's not daytime now. Go to sleep or you will feel like shit \uD83D\uDCA9";
    };
    update();
    requestAnimationFrame(update);
};

},{"./util/helpers":"biAg7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"biAg7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "timeZoneStr", ()=>timeZoneStr);
var _momentTimezone = require("moment-timezone");
var _momentTimezoneDefault = parcelHelpers.interopDefault(_momentTimezone);
const timeZoneStr = ()=>{
    const raw = (0, _momentTimezoneDefault.default).tz.guess();
    const city = raw.slice(raw.indexOf("/") + 1);
    const cachedTimeZoneStr = `${city}.`;
    return cachedTimeZoneStr;
};

},{"moment-timezone":"44wrF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"44wrF":[function(require,module,exports) {
var moment = module.exports = require("a3307e19e25878f5");
moment.tz.load(require("26482b68cc607116"));

},{"a3307e19e25878f5":"9vL8M","26482b68cc607116":"cILxB"}],"9vL8M":[function(require,module,exports) {
//! moment-timezone.js
//! version : 0.5.45
...
(function(root, factory) {
    "use strict";
    /*global define*/ if (0, module.exports) module.exports = factory(require("782152beb30574e4")); // Node
	...
	************************************/ function Zone(packedString) {
    ...
    function closest(num, arr) {
        ...
        else if (len > 1 && arr[len - 1] === Infinity && num >= arr[len - 2]) return len - 1;
        else if (num >= arr[len - 1]) return -1;
        var mid;
        var lo = 0;
        var hi = len - 1;
        while(hi - lo > 1){
	...
	************************************/ function OffsetAt(at) {
    ...
    function guessesForUserOffsets(offsets) {
        ...
        for(i = 0; i < offsetsLength; i++){
            ...
            if (checkedOffsets.hasOwnProperty(offset)) continue;
	...
	************************************/ function normalizeName(name) {
    ...
    function getNames() {
        var i, out = [];
        for(i in names)if (names.hasOwnProperty(i) && (zones[i] || zones[links[i]]) && names[i]) out.push(names[i]);
        return out.sort();
    }
	...
	************************************/ function tz(input) {
        ...
        if (!moment.isMoment(input) && needsOffset(out) && (zone = getZone(name))) out.add(zone.parse(out), "minutes");
        out.tz(name);
        return out;
    }
    tz.version = VERSION;
...
},{"782152beb30574e4":"jwcsj"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.30.1
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire2ab4")
